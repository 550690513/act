package org.crazyit.act.c30_dmn;
...
public class FirstDmn {
    ...
    public static void main(String[] args) {
        ...
        // 进行规则 部署
        DmnDeployment dep = rService.createDeployment().addClasspathResource("first.dmn").deploy();
        // 进行数据查询
        ...
        // 传入参数执行决策，并返回结果
        RuleEngineExecutionResult result = ruleService.executeDecisionByKey(dt.getKey(), params);
        // 控制台输出结果
