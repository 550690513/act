...
public class T02_SaleMain {
    ...
    public static void main(String[] args) {
        ...
        // 进行规则 部署
        DmnDeployment dep = rService.createDeployment().addClasspathResource("sale.dmn").deploy();
        // 根据部署对象查询决策表
        ...
        Double resultMoney = (Double) result.getResultVariables().get("resultMoney");
