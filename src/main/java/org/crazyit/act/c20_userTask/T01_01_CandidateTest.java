package org.crazyit.act.c20_userTask;
...
public class T01_01_CandidateTest {
    ...
    public static void main(String[] args) {
        ...
        Group manageG = is.newGroup("management");
        manageG.setName("management");

        is.saveGroup(bossG);
        is.saveGroup(manageG);
